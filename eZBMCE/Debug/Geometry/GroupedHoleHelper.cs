...
{
    internal class GroupedHoleHelper
    {
        /// <summary> 根据两个点创建出一个多边形，并在其中开孔，最终生成 GroupedHoleElement </summary>
        /// <param name="start"></param>
        /// <param name="opposite"></param>
        /// <returns></returns>
        public static Element CreateGroupedHoleElement(DPoint3d start, DPoint3d opposite)
        {
            ...
            int numHoles = 4;
            PopulateHolesAgenda(out holes, start, opposite, numHoles, model);
        ...
        private static void PopulateHolesAgenda(out ElementAgenda holes, DPoint3d start, DPoint3d opposite, int numHoles, DgnModel model)
        {
