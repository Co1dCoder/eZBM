    ...
    public class GeometryHelper
    {
            ...
            Bentley.GeometryNET.DPoint3d lastTangentStartPoint, Bentley.GeometryNET.DPoint3d lastTangentEndPoint, double arcRadius)
        {
            ...
            if (intersectionCollection.Count > 0)
            {
                ...
                //creating the arc
                Bentley.CifNET.LinearGeometry.CircularArc arc = 
                    Bentley.CifNET.LinearGeometry.CircularArc.Create8(
                        centerPoint, arcRadius*0.999999, startDirectionLine.Direction, endDirectionLine.Direction, hand);
                linElems.Add(arc);
