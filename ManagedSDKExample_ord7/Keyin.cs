...
namespace ManagedSDKExample
{
    ...
    public sealed class Keyin
    {
        ...
        /* MANAGEDSDKEXAMPLE -> CREATE -> CORRIDORITEMS -> TEMPLATEDROP
        /*------------------------------------------------------------------------------------**/
        public static void CmdCreateCorridorItemsTemplateDrop(string unparsed)
        {
            ManagedSDKExample.Instance().CorridorItemsTemplateDropCreators(unparsed);
        }

        /* MANAGEDSDKEXAMPLE -> CREATE -> CORRIDORITEMS -> KEYSTATION
        /*------------------------------------------------------------------------------------**/
        public static void CmdCreateCorridorItemsKeyStation(string unparsed)
        {
            ManagedSDKExample.Instance().CorridorItemsKeyStationCreators(unparsed);
        }

        /* MANAGEDSDKEXAMPLE -> CREATE -> CIVILCELL PLACE
        /*------------------------------------------------------------------------------------**/
        public static void CmdCreateCivilCellPlace(string unparsed)
        {
            ManagedSDKExample.Instance().CivilCellCreators();
        }

        /* MANAGEDSDKEXAMPLE -> CREATE -> SUPERELEVATION -> PLACE
        /*------------------------------------------------------------------------------------**/
        public static void CmdCreateSuperElevation(string unparsed)
        {
            ManagedSDKExample.Instance().SuperElevationCreators();
        }

        /* MANAGEDSDKEXAMPLE -> CREATE -> SUPERELEVATION -> ASSIGN
        /*------------------------------------------------------------------------------------**/
        public static void CmdAssignSuperElevation(string unparsed)
        {
            ManagedSDKExample.Instance().SuperElevationAssigns();
        }

        /* MANAGEDSDKEXAMPLE -> CREATE -> CURVEWIDENING -> PLACE
        /*------------------------------------------------------------------------------------**/
        public static void CmdCreateCurveWidening(string unparsed)
        {
            ManagedSDKExample.Instance().CurveWideningCreators();
        }
    }
}
