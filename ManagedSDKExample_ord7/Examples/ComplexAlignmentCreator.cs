...
namespace ManagedSDKExample
{
    class ComplexAlignmentCreator : DgnElementSetTool
    {
        ...
        internal void CreateComplexAlignmentFromPoints()
        {
            ...
            Bentley.CifNET.LinearGeometry.CircularArc arc = Bentley.CifNET.LinearGeometry.CircularArc.Create12(
                startSpiral.EndPoint.Coordinates, startSpiral.EndRadius, startSpiral.Direction + startSpiral.SweepAngle + System.Math.PI / 2.0, (System.Math.PI / 2.0) + (2 * startSpiral.SweepAngle), Hand.Clockwise);
